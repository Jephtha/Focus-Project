...
public class SetUp extends JFrame implements Serializable
{
  ...
  public void getConfirmation()
  {
    ...
    if(numOfPlayers==4)
    {
      confirmText = new JLabel("You have selected "+numOfPlayers+" human player(s), and "+(4-numOfPlayers)+" CPU players. Is this correct?");
    }
    else
    {
      confirmText = new JLabel("You have selected "+numOfPlayers+" human player(s), "+(4-numOfPlayers)+" CPU player(s) and a "+cpuDifficulty+" difficulty level. Is this correct?");
    }
